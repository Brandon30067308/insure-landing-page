...
const Hero: FC = () => {
  ...
  return (
    <div
      className="Hero w-full min-h-[1015px] sm:!min-h-[1315px] xs:min-h-[1090px] md:!min-h-[855px]
      mb-4"
    >
      <div className="w-full relative bg-primary flex justify-center items-start overflow-y-visible">
        ...
        >
          <div className="relative md:w-[40%] text-white max-w-xl px-3 sm:px-8 md:px-0 z-10">
            ...
            <p className="text-[15.3px] sm:text-base mb-5">
              Get your life insurance coverage easier and faster. We blend our
              expertise and technology to help you find the plan that’s right
              for you. Ensure you and your loved ones are protected.
            </p>
            <button
              className="z-10 uppercase font-[700] tracking-[0.085em] border-[1px] border-white
            text-[13.5px] sm:text-[15px] py-2 px-6 cursor-pointer hover:text-primaryDark
            hover:bg-white transition-all ease-linear"
            >
              view plans
            </button>
            {/* patterns for mobile */}
            {width <= breakpoints.sm && (
              <>
                ...
                {/* right */}
                <div className="-z-[1] absolute -bottom-64 right-0">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="124"
                    height="330"
          ...
          <div className="z-10 w-full md:w-fit">
            <img
              src={
                width <= breakpoints.xs ? imageIntroMobile : imageIntroDesktop
              }
              alt="intro-image-desktop"
              className="w-full md:w-[460px] min-w-[245px] sm:rounded-sm shadow-sm"
            />
          </div>
          {width > breakpoints.sm && (
            <>
              {/* right pattern  */}
              <div className="absolute -rotate-[30deg] -right-12 -top-24">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="436"
                  height="593"
              ...
              {/* left pattern */}
              <div className="absolute sm:rotate-0 -rotate-[30deg] left-0 -bottom-[20rem]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="195"
                  height="504"
