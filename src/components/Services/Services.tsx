...
const Services: FC = () => {
  return (
    <div className="Services w-full">
      <div
        className="w-full mx-auto lg:w-[85vw] max-w-[2160px] flex flex-col items-center md:items-start
        mb-4 px-3 sm:px-8"
      >
        <div className="mb-14 sm:mb-[72px] w-fit">
          <h2
            className="md:text-left text-center font-dmSerif text-[3rem] sm:text-6xl text-primaryDark
            leading-none"
          >
            We’re different
          </h2>
        </div>
        <div className="w-full flex items-start justify-start gap-8 flex-col md:flex-row">
          <div className="flex flex-col items-center md:items-start text-center md:text-left justify-start">
            <div className="rounded-[50%] bg-primaryAlt mb-5">
            ...
            <div>
              <h3 className="font-dmSerif text-2xl sm:text-3xl mb-1 sm:mb-2 text-primaryDark">
                Snappy Process
              </h3>
